...
main :: IO ()
main = do
    contents <- readFile "/home/miney/code/haskell/adventofcode/2021/15.txt"
    ...
    -- part 1
    print $ shortestDistance graph (0,0) (height-1,width-1)
    -- part 2
    print $ shortestDistance graph' (0,0) (height*5-1,width*5-1)
